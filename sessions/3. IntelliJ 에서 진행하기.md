...
1.  실습을 진행할 프로젝트를 생성합니다.<br>

    <figure><img src=".gitbook/assets/image.png" alt=""><figcaption></figcaption></figure>


2.  왼쪽 메뉴에서 '빈 프로젝트' 를 선택하고 '이름'과 '위치'를 지정하고 생성 버튼을 누릅니다. <br>

    <figure><img src=".gitbook/assets/image (1).png" alt=""><figcaption></figcaption></figure>

### Step 4: 로그인 및 권한 승인

1.  하단 오른쪽에 있는 아이콘을 누른 뒤 " Login to GitHub" 버튼을 클릭합니다.<br>

    <figure><img src=".gitbook/assets/unknown.png" alt=""><figcaption></figcaption></figure>


2.  Device Code 를 복사하고 \[Copy and Open] 버튼을 클릭합니다. <br>

    <figure><img src=".gitbook/assets/image (8).png" alt=""><figcaption></figcaption></figure>


3.  로그인한 계정을 선택해서 \[Continue] 버튼을 누릅니다.<br>
...
1.  IntelliJ 오른쪽 하단 상태 바에서 Copilot 아이콘을 확인합니다. <br>
...
1. 활성화된 버튼을 누르고 \[Open Chat] 버튼을 누릅니다.\
   \
   ![](<.gitbook/assets/image (12).png>)<br>
