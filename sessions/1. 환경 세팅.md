...
2. **Settings/Preferences 열기**
   - macOS: `⌘ + ,`
   - Windows: `Ctrl + Alt + S`
3. **Plugins → Marketplace 탭 클릭**
4. **GitHub Copilot 검색 및 설치**
...
* IDE 재시작 후 "Sign in to GitHub" 알림 표시
* "Sign In to GitHub" 버튼 클릭
* 브라우저에서 GitHub 계정 로그인
* 권한 승인 (Authorize)
* Device Activation 코드 입력 (자동 복사됨)

### Step 4: Copilot 활성화 확인하기

* IntelliJ 오른쪽 하단 상태 바에서 Copilot 아이콘 확인
* 아이콘이 활성화 상태면 정상

### Step 5: Copilot Chat 열기

1. **View → Tool Windows → GitHub Copilot Chat** 선택
2. 또는 오른쪽 사이드바에서 Copilot Chat 아이콘 클릭
