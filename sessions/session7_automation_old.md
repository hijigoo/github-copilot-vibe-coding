...
1. ✅ Excel 파일에서 특정 조건에 맞는 행만 필터링 (예: 결제 완료 고객만 추출)
2. ❌ 여러 폴더에 흩어진 이미지 파일을 날짜별로 정리
3. ⚠️ 이메일 주소가 포함된 텍스트 파일에서 이메일만 추출
...
## 🌟 실습 3: 이메일 주소 자동 추출 (선택사항)

⚠️ **난이도: 중급** - 정규표현식이 사용됩니다. 
🌟 **선택 과제**: 시간이 남으면 도전해보세요!

**건너뛰어도 됩니다**: 이 실습은 좀 더 고급 기술이 필요합니다. 실습 2까지만 해도 충분합니다.

**왜 중급인가요?**
- "정규표현식"이라는 복잡한 패턴 매칭 사용
- 개발자도 어려워하는 영역
- 실무에서 자주 안 씀 (Excel로 충분한 경우 많음)
...
## 🌟 실습 4: 파일 이름 일괄 변경 (선택사항)

⚠️ **난이도: 고급** - 파일 시스템 조작 (위험!)
🌟 **선택 과제**: 고급 사용자만 도전!

**⛔ 주의**: 이 실습은 잘못하면 파일이 삭제될 수 있습니다!
**💡 건너뛰세요**: 대부분의 PO는 이 기능이 필요 없습니다.
...
**⚠️ 난이도: 고급** - 이 과제들은 심화 학습을 원하시는 분들을 위한 것입니다.

시간이 충분하고 더 배우고 싶은 분들만 시도하세요!

### 도전 1: 웹 스크래핑 자동화
```
특정 웹사이트에서 매일 최신 뉴스 제목을 가져와서
Excel 파일로 저장하는 스크립트를 만들어줘.
웹 크롤링 도구(requests와 BeautifulSoup) 사용.
```
...
**💡 Tip**: 이 과제들은 워크숍 이후 혼자 연습하실 때 도전해보세요!
