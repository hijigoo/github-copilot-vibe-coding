...
| 1 | 빠른 시작 | Copilot 사용법 |
| 2 | 회의록 정리 | Action Item 자동 추출 |
| 3 | 문서 작성 | PRD 5분 만에 생성 |
| 4 | UX 리서치 | 피드백 자동 분석 |
| 5 | 데이터 분석 | HTML 리포트 생성 |
| 6 | 웹 페이지 | HTML 파일 생성 |
| 7 | 업무 자동화 | 반복 작업 스크립트 |

---

## 💪 실습 1: 나의 Copilot 활용 계획 세우기 (10분)

**목적**: 내일부터 당장 쓸 수 있는 실무 계획 만들기
...
2. 사용할 프롬프트 예시
3. 예상 시간 절약 효과
4. 간단한 표 형식으로 정리 (Mermaid 다이어그램 제외)

Markdown 형식으로 작성해줘.
```

**변경사항**: Mermaid 다이어그램 대신 간단한 표로 정리
- 이유: Mermaid 문법이 복잡하고 실무에서 잘 안 씀
- 대안: 체크리스트와 표가 더 실용적
...
## 💪 실습 2: 내일부터 바로 쓰는 체크리스트 (5분)

> **💡 목적**: 실제로 체크할 수 있는 실무 체크리스트
...
## ☀️ 일일 체크리스트 (매일 확인)
- [ ] 작업 항목 - 구체적인 활용법 (예상 시간 절약)

## 📅 주간 체크리스트 (주 1회 확인)
- [ ] 작업 항목 - 구체적인 활용법 (예상 시간 절약)

## 📋 실무 상황별 퀵 가이드
- 상황: 회의록 정리 필요 → Copilot 프롬프트: "..."
- 상황: PRD 작성 필요 → Copilot 프롬프트: "..."
- 상황: 데이터 분석 필요 → Copilot 프롬프트: "..."

실제로 체크할 수 있는 구체적인 항목으로 작성해줘.
PO/UX 실무자가 내일 당장 쓸 수 있도록.
```

---

## 💪 실습 3: 팀에 전파할 1장 요약 가이드 만들기 (5분)

> **💡 목적**: 팀원들에게 공유할 실전 가이드 (A4 1장)

### 프롬프트

```
우리 팀(PO/UX 팀)을 위한 
"GitHub Copilot 실무 활용 1장 요약"을 작성해줘.

다음 내용 포함:
1. ❓ Copilot이란? (1줄 설명)
2. 💪 왜 써야 하나? (혜택 3가지, 숫자로)
3. 🎯 Top 5 활용 상황
   - 회의록 정리: 프롬프트 예시
   - PRD 작성: 프롬프트 예시
   - 데이터 분석: 프롬프트 예시
   - UX 리서치: 프롬프트 예시
   - 반복 업무 자동화: 프롬프트 예시
4. ⚠️ 자주 하는 실수 3가지와 해결법
5. 📚 더 배우기 (링크 2개만)

A4 1페이지로, 
비개발자가 5분 만에 이해할 수 있게 작성해줘.
표와 이모지 활용해서 보기 쉽게.
```
