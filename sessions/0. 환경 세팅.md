...
### Step 1: Copilot으로 가상환경 설정하기

이제 Copilot에게 가상환경 설정을 요청해봅시다!
...
```
현재 프로젝트에 Python 가상환경(.venv)을 생성하고 활성화하는 방법을 알려줘.
내 운영체제는 [macOS/Windows/Linux]야.
터미널 명령어를 단계별로 알려주고, 활성화 확인 방법도 포함해줘.
```

3. **Copilot이 제공한 명령어 실행**

Copilot이 제공하는 명령어는 대략 다음과 같을 것입니다:
...
💡 **Tip**: Copilot이 당신의 운영체제에 맞는 명령어를 제공합니다!
